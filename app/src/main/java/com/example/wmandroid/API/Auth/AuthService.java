...
import static com.example.wmandroid.Utils.SD_CLIENT.api_customers_update;
import static com.example.wmandroid.Utils.SD_CLIENT.api_customers_updateAvatar;
...
public interface AuthService  {
    ...
    @PUT(api_customers_update)
    Call<RegisterCustomerDTO> customerUpdate(@Body RegisterCustomerDTO registerCustomerDTO);

    @PUT(api_customers_updateAvatar)
    Call<CustomerDTO> updateAvatar(@Body CustomerDTO CustomerDTO);
}
